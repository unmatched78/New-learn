...
"""
Base settings for HRMIS project.
...
LOCAL_APPS = [
    ...
    'apps.tenants',
    'apps.module_manager',
    'apps.hr_modules.employees',
    'apps.hr_modules.payroll',
    'apps.hr_modules.time_attendance',
    'apps.hr_modules.leave_management',
    'apps.hr_modules.performance',
    'apps.hr_modules.recruitment',
    'apps.hr_modules.benefits',
    'apps.hr_modules.learning',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='hrmis_db'),
